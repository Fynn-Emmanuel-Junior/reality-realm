      ...
      >
       <PerfectScrollbar  className="hor-scroll"
        ...
        >
          ...
          <div className="main-sidebar-header active" style={{width: '250px'}}>
            <NavLink className="header-logo active" to='/dashboard'>
              <img src= {imagesData('logo')}  className="main-logo  desktop-logo"  alt="logo" />
              <img src={imagesData('logowhite')} className="main-logo  desktop-dark"  alt="logo"/>
              <img src={imagesData('favicon')} className="main-logo  mobile-logo" alt="logo" />
              <img src={imagesData('faviconwhite')} className="main-logo  mobile-dark" alt="logo"  />
            </NavLink>
          </div>
                  ...
                  {Item.Items.map((menuItem:any, i:any) => (
                    <li className={`slide ${menuItem.selected ? "is-expanded" : ""}  ${menuItem.active ? "is-expanded" : ""}`} key={i}>
                      {menuItem.type === "link" ? (
                        ...
                        >
                          {menuItem.icon}
                          <span className="side-menu__label" style={{marginLeft: "10px"}}>
                            {menuItem.title}
                          </span>
                          {menuItem.badge ? (
                      ...
                      {menuItem.type === "sub" ? (
                        ...
                        >
                          ...
                          <span className="side-menu__label" style={{marginLeft: "10px"}}>{menuItem.title}{menuItem.active}</span>
                          {menuItem.badge ? (
