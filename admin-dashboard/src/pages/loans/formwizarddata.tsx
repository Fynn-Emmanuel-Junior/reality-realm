  ...
  render() {
    return (
      <Wizard step={this.state.step} onChange={this.handleStep}>
        ...
        <Step title="Documents Required" number="2">
          <section className="card-body Basicwizard ">
        ...
        <Step title="Loan Details" number="3">
          <section className="card-body Basicwizard ">
            <FormGroup className="control-group form-group">
            ...
            <FormGroup className="control-group form-group">
              ...
              <Form.Control type="text" className="form-control" required placeholder="11th May,2023" />
            </FormGroup>
            <FormGroup className="control-group form-group">
              <Form.Label className="form-label"> End Date </Form.Label>
              <Form.Control type="text" className="form-control" required placeholder="20th June ,2024" />
            </FormGroup>
            <FormGroup className="control-group form-group">
            ...
            <FormGroup className="control-group form-group">
              <Form.Label className="form-label"> Monthly Installement </Form.Label>
