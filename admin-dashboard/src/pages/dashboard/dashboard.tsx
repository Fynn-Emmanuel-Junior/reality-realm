                  ...
                  <Card.Header className=" border-bottom-0 d-flex">
                    ...
                    <div className="card-options ms-auto">
                      <div className="btn-group p-0">
                        <Button
                          className="btn btn-outline-light btn-sm br-tr-0 br-br-0"
                          type="button"
                          variant=""
                        >
                          Week
                        ...
                        <Button
                          className="btn btn-light btn-sm br-tr-0 br-br-0 br-tl-0 br-bl-0"
                          type="button"
                          variant=""
                        >
                          Month
                        ...
                        <Button
                          className="btn btn-outline-light btn-sm br-tl-0 br-bl-0"
                          type="button"
                          variant=""
                        >
                          Year
