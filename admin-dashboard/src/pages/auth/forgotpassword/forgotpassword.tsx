                      ...
                      <div className="main-card-signin d-md-flex bg-white">
                        <div className="wd-100p">
                          <div className="main-signin-header">
                            <div style={{color: "#0141CF",fontSize: "25px",fontWeight: 600}}> Forgot Password!</div>
                            ...
                            <Form action="#">
                              ...
                              <div style={{backgroundColor: "#0141CF",padding: "8px",borderRadius: "8px"}}>
                                          <div style={{display: 'flex',flexDirection: "column",alignItems: "center"}}>
                                            <Link to='/dashboard' style={{ color: "white"}}> Continue </Link>
                                          </div>
                                        </div>
