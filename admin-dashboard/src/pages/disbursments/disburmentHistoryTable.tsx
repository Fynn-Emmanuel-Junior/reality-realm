...
import { useDisbursement } from '@/hooks/useDisburment';
import DetailsModal from '../../components/DisburseLoanDetailsModal'; // Import your modal component
...
export const UserList = () => {
  const { GetAllDisbursements, data } = useDisbursement();
  ...
  useEffect(() => {
    if (data) {
      const formattedData: any = data.map((disburse: any) => disburse.transfer_response);
      setDataTable5(formattedData);
    }
  }, [data]);
