		...
		<Fragment>
			<div className="breadcrumb-header justify-content-between">
				<div className="left-content mt-2">
					...
					><i className="fe fe-plus me-2"></i>Add Distributor</Link>

					<Modal show={show} onHide={handleClose}>
						<Modal.Header className="modal-header">
							<h6 className="modal-title">Add Distributor</h6>
						...
						<Modal.Body className="modal-body"> <div className="p-4">
							<Form className="form-horizontal">
								...
								<FormGroup className="form-group">
									<Form.Control type="text" className="form-control" id="inputName1" placeholder="Location" />
								</FormGroup>
								<FormGroup className="form-group">
									<Form.Control type="email" className="form-control" id="inputEmail3" placeholder="Number of products" />
								</FormGroup>
								<FormGroup className="form-group">
								...
								<FormGroup className="form-group mb-0 justify-content-end">
									<div className="checkbox">
										<div className="custom-checkbox custom-control">
											...
											<label htmlFor="checkbox-2" className="custom-control-label mt-1 text-dark"> New Distributor</label>
										</div>
									</div>
								</FormGroup>
							</Form>
