      ...
      <span className="">
        <OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
          <Link to="#" className="btn btn-primary btn-sm rounded-11 me-2">
            <i>
              <svg className="table-edit" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="16">
    ...
    <div className="app-container">
      ...
      >
        <Modal.Header>
          ...
          <Button variant="" className="btn btn-close" onClick={() => setModalShow(false)}>
            x
          </Button>
        </Modal.Header>
        <Modal.Body>
          <Form onSubmit={handleAddFormSubmit} className="">
            ...
            <Form.Control
              ...
              className="form-control mb-2"
            />
            <Button variant="" className="btn btn-primary me-2 wd-100p " type="submit">
              Add
            </Button>
          </Form>
        </Modal.Body>
        <Modal.Footer>
          <Button className="btn btn-primary wd-20p" onClick={() => setModalShow(false)}>
            Close
          </Button>
        </Modal.Footer>
      </Modal>
  ...
  return (
    <tr>
      ...
      <td>
        ...
        <Button variant="" className="btn btn-danger me-1" type="button" onClick={() => handleDeleteClick(contact.id)}>
          Delete
        </Button>
      </td>
    </tr>
        ...
        <ButtonGroup size="sm" className="flex-nowrap">
          <OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
            <Button style={{ backgroundColor: '#FFB800' }}>
              <Link to="/edit-distributors" style={{ color: 'white' }}>
                Edit
              </Link>
            </Button>
          </OverlayTrigger>
          <OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>}>
            <Button style={{ backgroundColor: '#F33461' }}>
              <i className="fa fa-trash"></i>
            </Button>
          </OverlayTrigger>
          <OverlayTrigger placement="top" overlay={<Tooltip> Products </Tooltip>}>
            <Button style={{ backgroundColor: '#FFB800' }}>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="e-table pb-5">
                <div className="table-responsive ">
                  <table style={{ width: '100%', border: '1px solid rgba(0, 0, 0, 0.2)' }}>
                    <thead>
                      <tr style={{ fontSize: '15px' }}>
                        ...
                        <th style={{ fontWeight: '600', textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.1)' }}>
                          {' '}
                          Quantity of products{' '}
                        </th>
                        <th style={{ fontWeight: '600', textAlign: 'center' }}>Action</th>
                      </tr>
                    </thead>
                    <tbody style={{ padding: '20px' }}>
                      {/* Table rows */}
                      {/* Assuming DATATABLE is defined here */}
                      {DATATABLE5.map((row, index) => (
                        <tr key={index} style={{ margin: '30px', border: '1px solid rgba(0, 0, 0, 0.1)' }}>
                          <td
                            style={{
                              padding: '15px',
                              textAlign: 'center',
                          ...
                          <td style={{ padding: '15px', textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.1)' }}>
                            {row.LOCATION}
                          </td>
                          <td style={{ padding: '15px', textAlign: 'center', border: '1px solid rgba(0, 0, 0, 0.1)' }}>
                            {row.PRODUCTS}
                          ...
                          <td style={{ textAlign: 'center' }}>
                            ...
                            <ButtonGroup size="sm" className="flex-nowrap">
                              ...
                              <OverlayTrigger placement="top" overlay={<Tooltip> Delete Distributor </Tooltip>}>
                                <div
                                  onClick={() => handleDelete()}
                                  style={{
                                    backgroundColor: '#F33461',
                                    color: 'white',
                                    padding: '5px',
                                    cursor: 'pointer',
                                  }}
              ...
              <Modal show={reason} onHide={handleCloseDelete}>
                <Modal.Body>
                  <div>
                    <h6> Delete Distributor account </h6>
                    <div style={{ border: '1px solid rgba(0,0,0,0.2', padding: '10px', borderRadius: '5px' }}>
                      Are you sure you want to delete distributor
                    </div>
                  </div>
                </Modal.Body>
                <Modal.Footer>
